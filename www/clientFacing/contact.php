...
$address = 'info@arkedproductions.com';
$e_subject = 'You\'ve been contacted by ' . $name . ' from the website.';
$e_body = "You have been contacted by $name, here's what $name had to say:" . "\r\n" . "\r\n";
$e_content = "$comments" . "\r\n";
